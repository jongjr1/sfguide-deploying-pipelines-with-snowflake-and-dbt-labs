...
GRANT USAGE ON DATABASE STOCK_TRACKING_US_STOCK_PRICES_BY_DAY TO ROLE dbt_hol_role_{{env}};
GRANT USAGE ON SCHEMA STOCK_TRACKING_US_STOCK_PRICES_BY_DAY.STOCK TO ROLE dbt_hol_role_{{env}};
GRANT SELECT ON ALL TABLES IN SCHEMA STOCK_TRACKING_US_STOCK_PRICES_BY_DAY.STOCK TO ROLE dbt_hol_role_{{env}};

GRANT USAGE ON DATABASE FOREX_TRACKING_CURRENCY_EXCHANGE_RATES_BY_DAY TO ROLE dbt_hol_role_{{env}};
GRANT USAGE ON SCHEMA FOREX_TRACKING_CURRENCY_EXCHANGE_RATES_BY_DAY.STOCK TO ROLE dbt_hol_role_{{env}};
GRANT SELECT ON ALL TABLES IN SCHEMA FOREX_TRACKING_CURRENCY_EXCHANGE_RATES_BY_DAY.STOCK TO ROLE dbt_hol_role_{{env}};

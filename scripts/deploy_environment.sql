...
GRANT IMPORTED PRIVILEGES ON DATABASE ETF_FUND_FLOW_DATA TO ROLE dbt_hol_role_{{env}};
GRANT IMPORTED PRIVILEGES ON DATABASE CURRENCY_EXCHANGE_RATES TO ROLE dbt_hol_role_{{env}};
